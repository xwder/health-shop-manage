...
<style type="text/css">
/* search */
.search{border:2px solid #f58400;height:35px; width:600px;    }
...
.search input.btn_srh{background:#f58400;color:#FFF;font-family:"微软雅黑";font-size:15px;width:60px;    margin-left: 175px;}
</style>
</head>
<body>
	<div id="top">
		...
		<div id="search">
			<div id="sea" style="background-color: ;">
				 <div class="search radius6">
					<form name="searchform" method="get" action="http://localhost:8883/list.html">
						<input class="inp_srh" name="query"  placeholder="   请输入您要搜索的商品" >

...
<link rel="stylesheet" href="/css/emotion.css" type="text/css" media="screen" />
<link rel="stylesheet" href="/css/sinaFaceAndEffec.css" type="text/css" media="screen" />
<link rel="stylesheet" href="/css/bootstrap.min.css" type="text/css" media="screen" />
<link rel="stylesheet" href="/css/bootstrap-table.min.css" type="text/css" media="screen">

<script type="text/javascript" src="/js/jquery.js"></script>
<script type="text/javascript" src="/css/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
...
<body>
	...
	<div id="container">
		...
		<div id="content" style="height:auto;">
			...
			<jsp:include page="content/mynutritionist.jsp" />
		</div>
	</div>

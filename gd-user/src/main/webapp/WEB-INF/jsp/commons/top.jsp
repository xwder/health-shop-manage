        ...
        <div id="J_SiteNavBd">
            <div id="site-nav-l">
                ...
                <c:if test="${userinfo == null }">
                 ...
                 <c:if test="${userinfo != null }">
                 	<li class=home id="">
                        <a href="http://localhost:8881">返回首页</a>
                    </li>
                    <li class=home id="">
                        <a href="http://localhost:8885/user/userindex.html"> 欢迎${userinfo.username }</a>
                    </li>
            ...
            <div id="site-nav-r">
                <UL class=quick-menu>
					<LI class=home><a id="showuserindex" href="http://localhost:8885/user/userindex.html">个人中心</a> </LI>
                    ...
                    <LI class=cart>
                        <a href="http://localhost:8883/shop/cart.html" rel=nofollow>
                            <img src="/images/dhcart.png" alt="" >购物车 </a>
                    </LI>
                    <LI class=favorite>
                        <a href="#" rel=nofollow>  <img src="/images/dhsc.png" alt="" >收藏夹</a>
                    </LI>

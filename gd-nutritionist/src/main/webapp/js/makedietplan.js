...
function showfoodday2() {
	...
	/*$("#foodplandate").val(checkdate($("#foodplandate").val()));*/
...
function saveeverydayfoodplan(){
	if($("#foodplandate").val()==null||$("#foodplandate").val()==''){
		...
		if (!$("#foodplan1").is(':hidden')){			
			...
			if(dietflag==0){
				dateArray.push($("#foodplandate").val()),
				dateArray.push(checkdate($("#foodplandate").val(),1)),
	...
	$("#food3")
			.change(
					function() {
						...
						$("#foodnutrition").show();
						$.ajax({
							url : "/food/getfoodnutrition/"+ $("#food3").find("option:selected").val(),
						    async : false,
						    success : function(data) {
						    	if (data.data != null) {							
									$("#nengliang").html(data.data[0].energy);
									$("#water").html(data.data[0].watercontent);
									$("#danbaizhi").html(data.data[0].protein);
									$("#zhifang").html(data.data[0].fat);
									$("#xianwei").html(data.data[0].dietaryfiber);
									$("#tanshui").html(data.data[0].carbohydrate);
									$("#wA").html(data.data[0].vitaminsa);
									$("#wB1").html(data.data[0].vitaminsb1);
									$("#wB2").html(data.data[0].vitaminsb2);
									$("#wC").html(data.data[0].vitaminsc);
									$("#wE").html(data.data[0].vitaminse);
									$("#yansuan").html(data.data[0].niacin);
									$("#na").html(data.data[0].na);
									$("#gai").html(data.data[0].calcium);
									$("#tie").html(data.data[0].iron);
									$("#danguchun").html(data.data[0].cholesterol);
									$("#foodnutrition").show();
								} else
									alert("获取食材营养信息出错!");
						    }
